...
function moreContent(){
  var newMore = document.getElementById("more");
  newMore.innerHTML = bacon;
...
function lessContent(){
  var newLess = document.getElementById("less").style.display = "none";
}
...
var menuItems = ["Nuggets","Local Deluxe","Saimin"];

function valueMenu(){
  var mcMenu = document.createElement("p");
